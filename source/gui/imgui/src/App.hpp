...
private:
    ...
    static constexpr const char* kLayoutPaths[] = {
        "source/spatial_engine/speaker_layouts/allosphere_layout.json",
        "source/spatial_engine/speaker_layouts/translab-sono-layout.json",
        "source/spatial_engine/speaker_layouts/stereo.json",
        "source/spatial_engine/speaker_layouts/krakow_layout.json",
        "source/spatial_engine/speaker_layouts/layout_template.json",
        "source/spatial_engine/speaker_layouts/example_layouts/circle_16.json",
        "source/spatial_engine/speaker_layouts/example_layouts/circle_12.json",
        "source/spatial_engine/speaker_layouts/example_layouts/cube_8.json",
        "source/spatial_engine/speaker_layouts/example_layouts/ring12_top4.json",
        "source/spatial_engine/speaker_layouts/example_layouts/ring8_top4.json",
        "source/spatial_engine/speaker_layouts/example_layouts/dual_ring_16.json",
        "source/spatial_engine/speaker_layouts/example_layouts/octagon_8.json",
        "source/spatial_engine/speaker_layouts/example_layouts/quad_4.json",
        "source/spatial_engine/speaker_layouts/example_layouts/hexagon_6.json",
        "source/spatial_engine/speaker_layouts/example_layouts/5_1.json",
        ""
    };
